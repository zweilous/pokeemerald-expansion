...
static bool8 ExtractMonDataToSummaryStruct(struct Pokemon *mon)
{
    ...
    default:
        ...
        sMonSummaryScreen->relearnableMovesNum = P_SUMMARY_SCREEN_MOVE_RELEARNER ? (CanBoxMonRelearnMoves(&mon->box, MOVE_RELEARNER_LEVEL_UP_MOVES) ? 1 : 0) : 0;
        return TRUE;
    }
    sMonSummaryScreen->switchCounter++;
    return FALSE;
...
static bool8 CanReplaceMove(void)
{
    ...
    return !CannotForgetMove(sMonSummaryScreen->summary.moves[sMonSummaryScreen->firstMoveIndex]);
}
